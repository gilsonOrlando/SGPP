...
<head>
    ...
    <title>Bienvenido ~ Control Presupuesto </title>
        ...
        <div id="dashboard-container" class="container">
            <div id="left-container">
                <div id="panels-container">
                    ...
                    <div class="panel">
                        <div class="title">Gastos</div>
                        <div class="datum">$<?php echo number_format((float)$stats['max-expenses'], 2); ?></div>
                        <div class="description">Gasto máximo</div>
                    </div>
                    <div class="panel">
                        <div class="title">Gastos</div>
                        <div class="datum">$<?php echo number_format((float)$stats['avg-expenses'], 2); ?></div>
                        <div class="description">Gasto promedio</div>
                    </div>
                    <div class="panel">
                        <div class="title">Gastos</div>
                        <div class="datum">$<?php echo number_format((float)$stats['min-expenses'], 2); ?></div>
