...
<head>
    ...
    <title>Control Presupuesto</title>
</head>
        ...
        <div id="expenses-container" class="container">
            ...
            <div id="left-container">
                ...
                <div id="expenses-summary">
                    <div>
                        <h2>Responsable del Proyecto: <?php echo $user->getName() ?></h2>
                    </div>
                    <div class="cards-container">
                        <div class="card w-100">
                            <div class="total-budget">
                                <span class="total-budget-text">
                                    Gastos del actual mes
                                </span>
                            </div>
                        ...
                        <div class="card w-50">
                            <div class="total-budget">
                                <span class="total-budget-text">
                                    Del presupuesto de
                                    $<?php
                                        echo number_format($user->getBudget(), 2) . ' del Proyecto te restan';
                                        ?>
                                </span>
                            </div>
                            <div class="total-expense">
